                ...
                <div class="card-body">
                    <form method="POST" action="{{route('update', $department->id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{($department->title) }}" required autocomplete="email" autofocus> @error('title')
